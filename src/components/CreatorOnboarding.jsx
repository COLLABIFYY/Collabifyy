...
const CreatorOnboarding = ({ onComplete }) => {
    ...
    const handleNext = () => {
        ...
        if (step === 3) {
            ...
            if (missing) return alert("Please enter handles for all selected platforms.");
        }
    ...
    const handleSubmit = async () => {
        try {
            ...
            console.log("Creator profile saved:", data);
    ...
    return (
        <div className="onboarding-container">
            ...
            {step === 1 && (
                <div className="step-content">
                    <div className="onboarding-header">
                        ...
                        <p className="onboarding-subtitle">Select up to 3 categories that best describe your content.</p>
                    </div>
            ...
            {step === 3 && (
                <div className="step-content">
                    <div className="onboarding-header">
                        <h1 className="onboarding-title">Social Handles</h1>
                        ...
                        {platforms.map(platform => (
                            <div key={platform} className="form-group">
                                ...
                                <input
                                    ...
                                    placeholder={platform === "YouTube" ? "Channel URL or Name" : "@username"}
